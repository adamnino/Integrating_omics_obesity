############################################################################################################# 8.
##### 8. ML modelling (Fig.2; Table S9-11; Fig.S11&12)
setwd("~/Desktop")
...
## Define all models - Fig.2; Table S9; Fig.S11
model_list <- list(
...
############################################################################################################# 8.2.1
######### 8.2.1 Data extractions - Evaluation metrics 95% CI - Table S9 ########
...
############################################################################################################# 8.2.4
#### 8.2.4 Data extractions - p values b/t models on test sets - Table S10 #####
df_test <- all_metrics %>%
  filter(Set == "Test") %>% 
...
############################################################################################################# 8.3.3
##### 8.3.3 Figures for the best model - importance - Fig.S11; Table S11 #######
...
############################################################################################################# 8.3.4
################# 8.3.4 Correlation plot - Fig.S12; Table S11 ##################
cor_matrix <- df %>% 
