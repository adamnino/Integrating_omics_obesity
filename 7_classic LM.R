############################################################################################################# 7.
##### 7. Classic linear model (Table S8) & Study demographic characteristics (Table 1)
setwd("~/Desktop")  
...
############################################################################################################# 7.1
############## 7.1 Basic demographic characteristics - Table 1 ################
basic <- df[,-c(1,8:15)]
...
############################################################################################################# 7.3
#################### 7.3 Classic linear model - Table S8 ######################
model_list <- list(
